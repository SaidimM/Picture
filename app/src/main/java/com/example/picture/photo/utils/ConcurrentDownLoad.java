...
public class ConcurrentDownLoad {
    ...
    private long getContentLength() {
        ...
        HttpClient.Response<Long> response = httpClient.buildRequest(this.builder.url).GET()
                // 执行请求
        ...
        public void run() {
            try (RandomAccessFile file = new RandomAccessFile(builder.path, "rwd")) {
                ...
                httpClient.buildRequest(builder.url)
                        ...
                        .execute(HttpClient.Response.BodyHandlers.ofCallbackByteArray((data, index, length) -> {
