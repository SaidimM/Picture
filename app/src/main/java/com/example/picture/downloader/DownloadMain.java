package com.example.picture.downloader;

import com.example.picture.downloader.thread.DownloadThread;
import com.example.picture.downloader.thread.LogThread;
import com.example.picture.downloader.util.FileUtils;
import com.example.picture.downloader.util.HttpUtls;
import com.example.picture.downloader.util.LogUtils;
import com.example.picture.downloader.util.ThunderUtils;
...
public class DownloadMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String url = "https://repo.clojars.org/org/tobereplaced/nio.file/0.4.0/nio.file-0.4.0.jar";
